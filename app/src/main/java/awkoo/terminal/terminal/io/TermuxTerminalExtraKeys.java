...
public class TermuxTerminalExtraKeys extends TerminalExtraKeys {
    ...
    private void setExtraKeys() {
        ...
        try {
            ...
            String extrakeys = (String) mActivity.getProperties().getInternalPropertyValue(TermuxPropertyConstants.KEY_EXTRA_KEYS);
            String extraKeysStyle = (String) mActivity.getProperties().getInternalPropertyValue(TermuxPropertyConstants.KEY_EXTRA_KEYS_STYLE);
