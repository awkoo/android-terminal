package awkoo.terminal.shared.net.socket.local;
...
import awkoo.terminal.shared.android.ProcessUtils;
import awkoo.terminal.shared.android.UserUtils;
import awkoo.terminal.shared.logger.Logger;
//import awkoo.terminal.shared.markdown.MarkdownUtils;
...
public class PeerCred {
    ...
    public void fillPname(@NonNull Context context) {
        // If cpp did not set process name since it wouldn't be able to access /proc/<pid> of other
