...
public class TerminalShell {
    ...
    private void processResult() {
        if (mShellCommand.shouldNotProcessResults()) return;
        ...
        if (this.mExitCallback != null) {
            ...
            if (!mShellCommand.isStateFailed())
                mShellCommand.setState(ShellCommand.State.SUCCESS);
        }
    }
    ...
    public interface ExitCallback {
         ...
         */
        void onShellExited(TerminalShell terminalShell);
